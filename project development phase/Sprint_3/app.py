...
UPLOAD_FOLDER = ("E:\IBM Project\Project_Development_Phase\Sprint_3")


app = Flask(__name__)
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER

model = load_model("E:\IBM Project\Project_Development_Phase\Sprint_3\models\mnistCNN.h5")


@app.route('/')
def index():
    return render_template("E:\IBM Project\Project_Development_Phase\Sprint_3\templates\index.html")
